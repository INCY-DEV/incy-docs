...
- [Управление приложением](app-management.md) — HTTP-заголовки и параметры подписки (`hide-url`, баннер провайдера через `banner-*` заголовки, и др.)
...
- [Premium API](premium-api.md) — зашифрованный API конфигурации провайдера, лимиты устройств, резервные домены (`fallbackHosts`)
